...
-- ----------------------------
--  Records of `e_shop_cart`
-- ----------------------------
BEGIN;
INSERT INTO `e_shop_cart` VALUES ('126', '21', '26', '1', '1', '2017-04-13 21:27:06', '2017-04-13 21:27:06');
COMMIT;
...
CREATE TABLE `e_shop_product` (
  ...
  `category_id` int(11) NOT NULL COMMENT '分类id,对应e_shop_category表的主键',
...
-- ----------------------------
--  Table structure for `e_shop_shipping`
-- ----------------------------
DROP TABLE IF EXISTS `e_shop_shipping`;
CREATE TABLE `e_shop_shipping` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL COMMENT '用户id',
...
-- ----------------------------
BEGIN;
INSERT INTO `e_shop_user` VALUES ('1', 'admin', '427338237BD929443EC5D48E24FD2B1A', 'admin@happymmall.com', '13800138000', '问题', '答案', '1', '2016-11-06 16:56:45', '2017-04-04 19:27:36'), ('13', 'geely', '08E9A6EA287E70E7E3F7C982BF7923AC', 'geely@happymmall.com', '13800138000', '问题', '答案', '0', '2016-11-19 22:19:25', '2016-11-19 22:19:25'), ('17', 'rosen', '095AC193FE2212EEC7A93E8FEFF11902', 'rosen1@happymmall.com', '13800138000', '问题', '答案', '0', '2017-03-17 10:51:33', '2017-04-09 23:13:26'), ('21', 'soonerbetter', 'DE6D76FE7C40D5A1A8F04213F2BEFBEE', 'test06@happymmall.com', '13800138000', '105204', '105204', '0', '2017-04-13 21:26:22', '2017-04-13 21:26:22');
COMMIT;
